# Generated by Django 5.2.3 on 2025-07-04 03:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wishlist', models.ManyToManyField(blank=True, related_name='wishlist', to='classifieds.ad')),
            ],
            options={
                'verbose_name': 'Seller',
        ...
        migrations.AddField(
            model_name='ad',
            name='seller',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ads', to='classifieds.seller'),
        ),
        migrations.CreateModel(
            name='Customer',
            fields=[
                ...
                ('wishlist', models.ManyToManyField(blank=True, related_name='wishlisted_by', to='classifieds.ad')),
            ],
            options={
                ...
                'db_table': 'customer',
                'ordering': ['user'],
                'constraints': [models.UniqueConstraint(fields=('user',), name='unique_customer_user')],
            },
        ),
    ]
